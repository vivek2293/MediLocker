    ...
    <>
      <div className="container justify-content-center col-md-9" id="srchcont">
        <div className="helloPrompt text-center d-flex flex-column align-items-center">
          ...
          <p className="mx-md-5 mb-5 w-50 text-muted">
            You can search any patient using them email id and provide them with
            a prescription or check their medical history.
          </p>
        </div>
